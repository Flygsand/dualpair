 ...
 * \param[in] events the events that will trigger this callback
 * \param[in] flags hotplug callback flags (described above)
 * \param[in] vendor_id the vendor id to match or LIBUSB_HOTPLUG_PRODUCTID_ANY
 * \param[in] product_id the product id to match or LIBUSB_HOTPLUG_PRODUCTID_ANY
 * \param[in] dev_class the device class to match or LIBUSB_HOTPLUG_CLASS_ANY
